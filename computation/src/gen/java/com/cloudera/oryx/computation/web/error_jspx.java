 ...
 * Generated at: 2013-12-11 20:23:48 UTC
...
if (request.getAttribute("javax.servlet.error.message") != null) {
  ...
  pageContext.setAttribute("responseMessage", JspHelper.escapeXml(responseMessage));

      out.write("<p>");
      out.write("<strong>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${responseMessage}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("</strong>");
      out.write("</p>");
...
if (t != null) {
  ...
  pageContext.setAttribute("stackTrace", JspHelper.escapeXml(sw.toString()));
