...
public final class RandomManager {
  ...
  /**
   * This should generally never be used except in cases where RNG state must be explicitly shared.
   * Use {@link #getRandom()} to obtain a general purpose RNG.
   *
   * @param seed seed to use
   * @return a {@link RandomGenerator} explicitly seeded with the given value.
   */
  public static RandomGenerator getSeededRandom(long seed) {
    // Don't track these
